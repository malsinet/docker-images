...
:results:
total 0
drwxr-xr-x  2 martin  staff    64B Feb  2 22:20 .
drwxr-xr-x  7 martin  staff   224B Feb  2 22:20 ..
:end:
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/php/5.6/Dockerfile :mkdirp yes
FROM php:5.6-apache
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/php/7.1/Dockerfile :mkdirp yes
FROM php:7.1-apache
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/php/7.2/Dockerfile :mkdirp yes
FROM php:7.2-apache
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/php/7.3/Dockerfile :mkdirp yes
FROM php:7.3-apache
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/php/composer/Dockerfile :mkdirp yes
FROM composer:1.8
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/python/2.7/Dockerfile :mkdirp yes
FROM python:2.7
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/python/3.6/Dockerfile :mkdirp yes
FROM python:3.6
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/java/7-jre/Dockerfile :mkdirp yes
FROM openjdk:7-jre
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/java/7-jdk/Dockerfile :mkdirp yes
FROM openjdk:7-jdk
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/java/8-jre/Dockerfile :mkdirp yes
FROM openjdk:8-jre
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/java/8-jdk/Dockerfile :mkdirp yes
FROM openjdk:8-jdk
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/scheme/Dockerfile :mkdirp yes
FROM debian:stable
...
#+BEGIN_SRC dockerfile :exports code :padline no :tangle build/texlive/Dockerfile :mkdirp yes
FROM ubuntu:xenial
MAINTAINER Martin Alsinet <martin@alsinet>
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/composer :mkdirp yes
#!/bin/sh
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/php-5.6 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm -i \
           -v $(pwd):/app \
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/php-7.1 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm -i \
           -v $(pwd):/app \
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/php-7.2 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm -i \
           -v $(pwd):/app \
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/php-7.3 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm -i \
           -v $(pwd):/app \
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/python-2.7 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/pip-2.7 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/virtualenv-2.7 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm -i \
           -v $(pwd):/app \
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/python-3.6 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/pip-3.6 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/virtualenv-3.6 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm -i \
           -v $(pwd):/app \
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/python-3.7 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/pip-3.7 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/virtualenv-3.7 :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm -i \
           -v $(pwd):/app \
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/pygmentize :mkdirp yes
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm -ti \
           -v $(pwd):$(pwd) \
...
#+BEGIN_SRC sh :exports code :padline no :tangle build/bin/yarn-10
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm \
           -v $(pwd):/app \
