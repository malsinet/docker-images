...
- prettier :: Se instala [[https://prettier.io][prettier]] globalmente
...
#+BEGIN_SRC sh :tangle build/bin/prettier-node-10
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm -i \
           -v $(pwd):/app \
...
#+BEGIN_SRC sh :tangle build/bin/prettier-node-11
#!/bin/sh
export PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin
docker run --rm -i \
           -v $(pwd):/app \
