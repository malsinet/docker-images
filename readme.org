...
Basándonos en la imagen de python3.6 que ya tenemos construida instalamos además ZeroMQ y nodejs, lo que permite ejecutar código javascript dentro de Jupyter.
